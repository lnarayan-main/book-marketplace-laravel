...
@section('content')
<div class="max-w-xl">
    <a href="{{ route('admin.customers.index') }}" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-900 mb-4 transition">
        <i class="fa fa-arrow-left mr-2"></i> Back to Customer List
    </a>
    ...
    <div class="bg-white p-8 rounded-lg shadow-sm border border-slate-200">
        <div class="mb-6">
            ...
            <p class="text-sm text-slate-500">Provide the details to create a new customer account. They will be able to log in immediately after registration.</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-indigo-50 border-l-4 border-indigo-400 p-4 mt-2">
                    <p class="text-xs text-indigo-700">
                        ...
                        The new account will be created with the <strong>Customer Role (0)</strong> and will be automatically marked as verified.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
                    ...
                    <a href="{{ route('admin.customers.index') }}" class="text-slate-600 hover:text-slate-900 text-sm font-medium">Cancel</a>
                </div>
            </div>
        </form>
    </div>
