            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="w-full lg:w-1/2 overflow-hidden">
                    <div class="swiper-container gallery-top mb-4 rounded border bg-gray-50">
                        <div class="swiper-wrapper">
                            @for ($i=0; $i<5; $i++)
                            <div class="swiper-slide"><img src="{{  asset('storage/'.$book->cover_image) }}"
                                    class="w-full h-auto object-cover" alt="Product"></div>
                            @endfor
                        </div>
                    </div>
                    <div class="swiper-container gallery-thumbs">
                        <div class="swiper-wrapper">
                            ...
                            <div
                                ...
                                <img src="{{  asset('storage/'.$book->cover_image) }}" class="w-full"
                                    alt="Thumb">
                            </div>
                            @endfor
                        </div>
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <span class="text-xl text-gray-400 line-through">${{ $book->price + 30 }}</span>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-4 mb-8">
                        <div class="flex border rounded">
                            ...
                            <input type="number" id="qty-input" value="1" class="w-12 text-center focus:outline-none"
                                readonly>
                            <button class="qty-btn px-3 py-2 hover:bg-gray-100" onclick="updateQty(1)">+</button>
                        </div>
                    ...
                    <div class="space-y-2 text-sm text-gray-600 border-t pt-6">
                        ...
                        <p><span class="font-bold text-gray-800 w-24 inline-block">Categories:</span> <a href="#"
                                class="hover:text-primary">Office</a>, <a href="#" class="hover:text-primary">Home</a>
                        </p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div id="desc" class="tab-content">
                    <p class="leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                        tempor incididunt ut labore et dolore magna aliqua. Ut enimlo ad minim veniam, quis nostrud
                        exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
                        reprehen in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                        cupidatat non proident, sunt in culpa qui officiarty deserunt mollit anim id est laborum.</p>
                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="group text-center">
                            <div class="relative overflow-hidden bg-gray-100 rounded mb-4">
                                <a href="{{  route('home.book-detail', $relatedBook) }}"><img src="{{  asset('storage/'.$relatedBook->cover_image) }}"
                            ...
                            <h4 class="font-medium hover:text-primary"><a href="{{  route('home.book-detail', $relatedBook) }}">{{ $relatedBook->title }}</a></h4>
                            <p class="text-primary font-bold mt-1">${{ $relatedBook->price }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
